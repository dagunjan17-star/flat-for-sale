...
export const metadata = {
  title: "Contact Us – Enquire About Flats for Sale in Gurgaon | Free Property Consultation",
  
  description:
    "Looking to buy flats for sale in Gurgaon? Contact our property experts for free consultation – find verified 2BHK, 3BHK & luxury apartments in Gurgaon on Sohna Road, Dwarka Expressway & Golf Course Road. Ready to move & new launch flats available. Enquire now, we'll get back shortly!",
