    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-12">
        ...
        <p className="mt-4 text-gray-500 max-w-2xl">
          Discover premium {bhk} BHK flats available in prime Gurgaon sectors
          including Golf Course Road, Dwarka Expressway, Sohna Road and New
          Gurgaon.
        </p>
          ...
          {properties.map((property, index) => {
            ...
            return (
              <div key={property._id}>
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition duration-300 overflow-hidden md:h-[280px]">
                  <div className="flex flex-col md:flex-row h-full">
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      ...
                      <div className="border-t border-gray-200 mt-5 pt-4 flex justify-between items-center text-sm text-gray-500 font-medium">
                        
                        {/* Explore more with arrow */}
                        <Link
