...
export default function BlogList() {
  ...
  return (
    <section
      id="blog-section"
      className="px-4 sm:px-6 lg:px-0 max-w-7xl mx-auto py-10
    ...
    >
      ...
      <div className="mb-14">
        ...
        <p className="text-gray-600 mt-4 max-w-2xl">
          ...
          to find the best flats for rent in Gurgaon.
        </p>
      ...
      {loading && (
        <div className="flex justify-center items-center py-24">
          <div className="relative flex items-center justify-center">
            ...
            bg-[#143D60]/20 blur-xl animate-pulse"></div>

            {/* RING */}
            <div className="w-16 h-16 rounded-full border-[5px] border-[#143D60]/10"></div>

            {/* SPINNER */}
            <div className="absolute w-16 h-16 rounded-full 
            border-[5px] border-transparent 
            border-t-[#143D60] border-r-[#0f2c46] 
            animate-spin"></div>

            {/* CENTER DOT */}
            <div className="absolute w-3 h-3 bg-[#143D60] rounded-full shadow-md"></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            {blogs.map((post, index) => (
              <Link
                ...
                border border-[#143D60]/10 transition duration-300 hover:-translate-y-1"
              >
                ...
                <div className="p-6">
                  ...
                  bg-[#143D60]/10 text-[#143D60] px-3 py-1 rounded-full mb-3">
                    {post?.Category || post?.category || "General"}
                  </span>

                  <h3 className="text-lg font-semibold text-gray-900 leading-snug mb-3 group-hover:text-[#143D60] transition">
      ...
      {!loading && !error && Array.isArray(blogs) && blogs.length === 0 && (
        <div className="flex flex-col items-center justify-center text-center py-20">
          ...
          <button
            ...
            bg-gradient-to-r from-[#143D60] to-[#0f2c46] text-white hover:opacity-90 transition"
          >
            Refresh
          </button>
