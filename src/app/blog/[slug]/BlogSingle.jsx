...
export default function BlogDetails({ post }) {
  ...
  return (
    ...
    bg-gradient-to-b from-white to-[#e8f1f8] py-10">
<div className="mb-6">
   <Breadcrumb />
  </div>
      {/* LEFT SIDE */}
              ...
              {section?.img?.url && (
                <div className="w-full my-6">
                  <Image
                    ...
                    shadow-sm border border-[#143D60]/10"
                  />
                </div>
              )}
            ...
            <div className="mt-14">
              ...
              <div className="space-y-4 max-w-6xl mx-auto">
                ...
                {single.FAQs.map((faq, i) => (
                  <details
                    key={i}
                    className="group bg-white border border-[#143D60]/10 rounded-xl p-4 
                    shadow-sm hover:shadow-md transition duration-300"
                  >

                    <summary className="flex justify-between items-center cursor-pointer list-none">

                      <span className="font-semibold text-gray-900 group-hover:text-[#143D60] transition">
                        {faq.Q}
                      </span>

                      <span className="ml-4 text-[#143D60] transition-transform duration-300 group-open:rotate-180">
                        ▼
                      </span>
                    </summary>

                    <div className="mt-3 text-gray-600 leading-relaxed border-t border-[#143D60]/10 pt-3">
                      {faq.A}
                    </div>
