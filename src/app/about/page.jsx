...
export const metadata = {
  title: "About Us – Trusted Platform for Flats for Sale in Gurgaon | 2500+ Verified Listings",

  description:
    "We are Gurgaon's most trusted platform for flats for sale – 2500+ verified 1BHK, 2BHK & 3BHK flats in Gurgaon. Browse luxury apartments, ready to move & new launch flats on Golf Course Road, Sohna Road & Dwarka Expressway. 5000+ buyers served. Find your perfect Gurgaon flat today!",
  ...
  keywords: [
   ...
   alternates: {
    canonical: "https://www.flatsforsaleingurgaon.com/about",
  },
};
