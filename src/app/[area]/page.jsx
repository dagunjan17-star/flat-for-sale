...
const DOMAIN = "www.flatsforsaleingurgaon.com";
const BASE_URL = "https://gurgaon-backend.onrender.com";

// Fallback SEO
const FALLBACK_META = {
  title: "Flats for Sale in Gurgaon | Affordable & Luxury Apartments",
  description:
    "Explore flats for sale in Gurgaon including affordable apartments, luxury residences, and modern homes in prime locations.",
};
