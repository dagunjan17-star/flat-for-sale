...
export async function generateSitemap() {
  ...
  const staticUrls = `
    ...
    <url><loc>${baseUrl}/how-it-works</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/1-bhk-flats-for-sale-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/2-bhk-flats-for-sale-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/3-bhk-flats-for-sale-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
    <url><loc>${baseUrl}/listing/4-bhk-flats-for-sale-in-gurgaon</loc>
     <lastmod>${currentDate}</lastmod></url>
